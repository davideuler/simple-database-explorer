...
class Console2(Qsci.QsciScintilla):
    def __init__(self, prompt='>>> ', startup_message='', parent=None):
    ...
    def newPrompt(self):
        ...
        #self.lines
        #self.append("____")
        #self.setCursorPosition(QtGui.QTextCursor.End)
    ...
    def keyPressEvent(self, event):
        ...
        if event.key() == QtCore.Qt.Key_PageUp:
            ...
            self.close()
        super(Console2, self).keyPressEvent(event)


if __name__ == '__main__':
    app = QtGui.QApplication(sys.argv)
    console = Console2(startup_message="this is python")
